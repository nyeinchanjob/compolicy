...
class QuestionType {
  ...
  function checkQuestionTypeName() {
    $query = 'SELECT
  ...
  function create() {
    ...
    if ($stmt->execute()){
      ...
      echo '<pre> <br/>Question Type Create Error<br/>';
  ...
  function update() {
      ...
      if ($stmt->execute()) {
        ...
        echo '<pre> <br/>Question Type Update Error<br/>';
  				print_r($stmt->errorInfo());
  			echo '</pre>';
  			return false;
      }
  ...
  function delete() {
    ...
    if ($stmt->execute()) {
      ...
      echo '<pre> <br/>QuestionType Delete Error<br/>';
        print_r($stmt->errorInfo());
      echo '</pre>';
      return false;
    }
